 ...
 * @Target({"CLASS"})
 */
final class UrlParameterObject extends AustralEntityAnnotation
{
   ...
   * @var string|null
   */
  public ?string $methodUrlName = null;
   ...
   */
  public function __construct($methodGenerateLastPath = null, $keyForObjectLink = null, $methodUrlName = null) {
